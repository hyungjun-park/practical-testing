...
import static simple.cafekiosk.spring.domain.product.ProductType.*;
...
class OrderStatisticsServiceTest {
    ...
    void sendOrderStatisticsMail() {
        // given
        LocalDateTime now = LocalDateTime.of(2023, 11, 6, 0, 0);
        ...
        Order order1 = createPaymentCompletedOrder(products, LocalDateTime.of(2023, 11, 5, 23, 59, 59));
        Order order2 = createPaymentCompletedOrder(products, now);
        Order order3 = createPaymentCompletedOrder(products, LocalDateTime.of(2023, 11, 6, 23, 59, 59));
        Order order4 = createPaymentCompletedOrder(products, LocalDateTime.of(2023, 11, 7, 0, 0));
        ...
        // when
        boolean result = orderStatisticsService.sendOrderStatisticsMail(LocalDate.of(2023, 11, 6), "test@test.com");
